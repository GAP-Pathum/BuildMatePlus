...
export default function SupConnect() {
    ...
    <div>
      ...
      <div className="contact-image-container">
        ...
        <div className="contact-white-container" style={{padding:'5%'}}>
          <div className='contact-head'>BUILD YOUR TEAM</div>
          <p className='para'>
          ...
          <div className='orange-container'>
            <div className="orange-container1">
              <div className='para1'>Find Service Suppliers For your construction</div>
              <div className="connect-02">
                <button className="con-button" onClick={() => window.location.href = '/Pages/Architecture'}>
                Find Service Supplier
              </button>
              </div>
              <div className='sen1'>More Details</div>
            </div>
            <div className="orange-container1">
              <div className='para1'>Find Material Suppliers for Your Construction</div>
              <div className="connect-02">
